            ...
            <div className="d-flex flex-column align-items-center text-center p-3 py-5">
              <div className="profile-img mt-5">
                <img
                  className="img-edit"
                  src={
                    profileImage.filedisplay ||
                    "https://ncs.cd.gov.mn/wp-content/themes/icetheme/assets/images/no-image-small.png"
                  }
                  alt=""
                />
          ...
          <div className="col-md-5 border-right">
            <div className="p-3 py-5">
              ...
              <div className="row mt-2">
                ...
                {errors.full_name && (
                  <span className="" style={{ color: "#ff5470" }}>
          ...
          <div className="col-md-4">
            <div className="p-3 py-5">
              <div className="d-flex justify-content-between align-items-center experience">
                <span>Bio and Link</span>
                <span className="border px-3 p-1 add-experience">Go back</span>
              </div>
              <br />
              <div className="col-md-12">
                ...
                <textarea
                  ...
                  rows="3"
                  {...register("bio_txt", { required: true })}
                />
              </div>
              {errors.bio_txt && (
                <span className="" style={{ color: "#ff5470" }}>
              ...
              {errors.social_link && (
                <span className="" style={{ color: "#ff5470" }}>
                  <FontAwesomeIcon icon={faCircleExclamation} beatFade />{" "}
                  <small> Social link is required</small>
                </span>
              )}
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-md-4">
              <div className="profile-img">
                <img
                  className="img-edit image-rounded"
            ...
            <div className="col-md-6">
              <div className="profile-head">
                ...
                <h6>Dent and Collision Repair</h6>
            ...
            <div className="col-md-2" title="edit profile">
              <img
                className="mb-1"
                src={process.env.PUBLIC_URL + "/img/edit/edit.svg"}
                alt=""
                width="20"
                height="20"
              />
          ...
          <div className="row">
            <div className="col-md-4">
              <div className="profile-work">
                <h6 className="mt-5">
                  <FontAwesomeIcon icon={faMapMarkerAlt} /> Karuruma, Kigali,
                  Rwanda
                </h6>
                <p>LINK</p>
                ...
                <p>BIO</p>
                <Link className="link">
                  Born in 1985, John Rodriguez turned his childhood passion for
                  cars into a thriving career. Specializing in auto repair, he
                  founded "Rodriguez Auto Care" in 2012.
                </Link>
              </div>
            </div>
